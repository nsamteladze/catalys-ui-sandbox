...
<template>
  ...
  <div class="min-h-screen flex relative lg:static surface-ground">
    <div id="app-sidebar-3"
      ...
      <div class="flex flex-column h-full">
        <div class="flex align-items-center px-5 flex-shrink-0" style="height:60px">
          <img src="../assets/logo_color_no_background.svg" alt="Image" height="55" />
        </div>
        <div class="overflow-y-auto">          
          <a v-ripple
            class="m-3 flex align-items-center cursor-pointer p-3 border-round hover:bg-indigo-500 text-gray-800 hover:text-white transition-duration-150 transition-colors p-ripple">
        ...
        <div class="overflow-y-auto">
          <ul class="list-none p-3 m-0">
            <li>
              <span class="block p-3 text-gray-600" style="text-transform: uppercase;">Financial Accounting</span>
            </li>
            <li>
              <a v-ripple
    ...
    <div class="min-h-screen flex flex-column relative flex-auto overflow-auto">
      <div
        class="flex justify-content-between align-items-center px-5 surface-0 border-bottom-1 surface-border relative lg:static overflow-auto"
        style="height:60px">
      ...
      <div class="p-5 flex flex-column flex-auto overflow-auto" style="height: 100px;">
    ...
    <div class="min-h-screen flex flex-column relative flex-auto overflow-auto">
      ...
      <div class="p-5 flex flex-column flex-auto" style="height: 100px;">
        <div class="p-5 border-2 border-dashed surface-border border-round surface-section flex-1">
            This is where the chat bot will be 
        </div>
      </div>
    </div>
  </div>
